...
-confirm -NewVHDSizeBytes 20GB -path "C:\Users\$env:UserName\Virtual Machines\$VMname";
...
Add-VMDvdDrive $VMname -path 'D:\Operating Systems Images\Microsoft\Server 2012 R2 Evaluation.ISO'
